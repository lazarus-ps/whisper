...
import pl.mdcode.config.audit.AuditEventConverter;
import pl.mdcode.domain.PersistentAuditEvent;
...
import static pl.mdcode.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
