...
import pl.mdcode.domain.Address;
import pl.mdcode.domain.UserData;
import pl.mdcode.repository.AddressRepository;
...
public class AddressResourceIntTest {
    ...
    private static final String DEFAULT_PLACE_OR_CITY = "AAAAAAAAAA";
    private static final String UPDATED_PLACE_OR_CITY = "BBBBBBBBBB";
    ...
    public static Address createEntity(EntityManager em) {
        Address address = new Address()
            .placeOrCity(DEFAULT_PLACE_OR_CITY)
            .street(DEFAULT_STREET)
            .province(DEFAULT_PROVINCE)
            .postalCode(DEFAULT_POSTAL_CODE);
        // Add required entity
        UserData userData = UserDataResourceIntTest.createEntity(em);
        em.persist(userData);
        em.flush();
    ...
    public void createAddress() throws Exception {
        ...
        assertThat(testAddress.getPlaceOrCity()).isEqualTo(DEFAULT_PLACE_OR_CITY);
    ...
    @Test
    @Transactional
    public void checkPlaceOrCityIsRequired() throws Exception {
        int databaseSizeBeforeTest = addressRepository.findAll().size();
        // set the field null
        address.setPlaceOrCity(null);
    ...
    public void getAllAddresses() throws Exception {
        ...
        restAddressMockMvc.perform(get("/api/addresses?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].placeOrCity").value(hasItem(DEFAULT_PLACE_OR_CITY.toString())))
    ...
    public void getAddress() throws Exception {
        ...
        restAddressMockMvc.perform(get("/api/addresses/{id}", address.getId()))
            ...
            .andExpect(jsonPath("$.placeOrCity").value(DEFAULT_PLACE_OR_CITY.toString()))
    ...
    public void updateAddress() throws Exception {
        ...
        updatedAddress
            .placeOrCity(UPDATED_PLACE_OR_CITY)
        ...
        Address testAddress = addressList.get(addressList.size() - 1);
        assertThat(testAddress.getPlaceOrCity()).isEqualTo(UPDATED_PLACE_OR_CITY);
